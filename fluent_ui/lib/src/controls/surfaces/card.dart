...
class Card extends StatelessWidget {
  ...
  ///
  /// Defaults to `BorderRadius.all(Radius.circular(8.0))` to align with WinUI 3 guidelines.
  /// A subtle shadow is also applied for elevation.
  ///
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: theme.shadows.elevation8, // Apply the standardized shadow
      ),
      padding: padding,
      child: child,
    );

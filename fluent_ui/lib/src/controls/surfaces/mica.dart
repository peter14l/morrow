...
enum MicaType {
  /// The standard Mica material.
  standard,

  /// The Mica Alt material, which has a slightly deeper tint and increased
  /// contrast.
  alt,
}
...
class Mica extends StatelessWidget {
  ...
  ///
  /// If null, [FluentThemeData.micaBackgroundColor] or
  /// [FluentThemeData.micaAltBackgroundColor] is used based on [type].
  ...
  /// The type of Mica material to use.
  ///
  /// Defaults to [MicaType.standard].
  final MicaType type;
  ...
  Widget build(BuildContext context) {
    ...
    // If the window is not focused, Mica surfaces should become solid
    if (!theme.windowFocused) {

    ...
    return Column(
      children: [
        ...
        const OasisLogoMark()
            ...
            .scale(duration: 900.ms, curve: Curves.elasticOut, begin: const Offset(0.6, 0.6))
        ...
        if (isActive)
          ...
          Text('oasis', style: OasisTextStyles.onboardingHeadline.copyWith(fontSize: 52)),
        ...
        ).animate(target: isActive ? 1 : 0).slideY(begin: 0.15, delay: 1600.ms).fadeIn(delay: 1600.ms),
        const Spacer(),
        const Icon(Icons.keyboard_arrow_down, color: OasisColors.glow, size: 22)
            .animate(onPlay: (c) => c.repeat())
            .moveY(begin: 0, end: 8, duration: 1.4.seconds, curve: Curves.easeInOut),
        Text(
          'Swipe to explore',
          style: OasisTextStyles.onboardingSubtitle.copyWith(
            fontSize: 12,

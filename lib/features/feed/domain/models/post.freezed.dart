...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,username,userAvatar,content,imageUrl,thumbnailUrl,dominantColor,const DeepCollectionEquality().hash(mediaUrls),const DeepCollectionEquality().hash(mediaTypes),const DeepCollectionEquality().hash(hashtags),isSpoiler,communityId,communityName,timestamp,likes,comments,shares,isLiked,isBookmarked,isAd,isVerified,storageProvider,mood,poll]);

@override
String toString() {
  return 'Post(id: $id, userId: $userId, username: $username, userAvatar: $userAvatar, content: $content, imageUrl: $imageUrl, thumbnailUrl: $thumbnailUrl, dominantColor: $dominantColor, mediaUrls: $mediaUrls, mediaTypes: $mediaTypes, hashtags: $hashtags, isSpoiler: $isSpoiler, communityId: $communityId, communityName: $communityName, timestamp: $timestamp, likes: $likes, comments: $comments, shares: $shares, isLiked: $isLiked, isBookmarked: $isBookmarked, isAd: $isAd, isVerified: $isVerified, storageProvider: $storageProvider, mood: $mood, poll: $poll)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,username,userAvatar,content,imageUrl,thumbnailUrl,dominantColor,const DeepCollectionEquality().hash(_mediaUrls),const DeepCollectionEquality().hash(_mediaTypes),const DeepCollectionEquality().hash(_hashtags),isSpoiler,communityId,communityName,timestamp,likes,comments,shares,isLiked,isBookmarked,isAd,isVerified,storageProvider,mood,poll]);
